            ...
            <div className="container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md) px-4 space-y-14 ">
                <div className="text-center">
                    ...
                    <div className="text-center pb-6">
                        <div className="inline-flex items-center rounded-xl p-2 shadow-lg">
                            <button className={`py-3 px-7 rounded-xl ${tabConfig.planType === "Monthly" ? "bg-dark text-white" :"bg-transparent text-black"
                            }`} onClick={()=>dispatch({
                                type:"Monthly",
                                payload:{
                                    duration:"per month",
                            ...
                            <button className={`py-3 px-7 rounded-xl ${tabConfig.planType === "Yearly" ? "bg-dark text-white" :"bg-transparent text-black"
                            }`} onClick={()=>dispatch({
                                type:"Yearly",
                                payload:{
                                    duration:"per year",
                ...
                <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-8 mt-12">
                        <div className="bg-white pt-8 px-8 rounded-2xl shadow hover:shadow-lg transition">
                            ...
                            <p className="text-start mt-4 text-muted text-sm mb-8">Through a combination of our data-driven insights and innovative approches.</p>
                        ...
                        <div className="bg-white pt-8 px-8 rounded-2xl shadow hover:shadow-lg transition">
                            <h3 className="text-22 font-bold text-start text-black font-chakrapetch">Standard Plam</h3>
                            <div className="mt-4 flex items-center justify-center">
                                <p className="text-48 py-5 uppercase font-bold font-mona">${tabConfig.standardPrice}</p>
                                <sub className="text-xs">${tabConfig.duration}</sub>
                            </div>
                            <p className="text-start mt-4 text-muted text-sm mb-8">Through a combination of our data-driven insights and innovative approches.</p>
                            <span className="font-semibold text-xl">Plan Included:</span>
