    ...
    return(
        <>
         ...
         <div className='container  mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md) ' >
            <div className="blog-content mb-10 text-center">
...
/>
                                ...
                                <div className="blog-content px-2 py-5 space-y-5">
                                    ...
                                    Read More <Icon icon="tabler:arrow-right" width="24" height="24" className='bg-prim text-white rounded-full h-full w-[30px] p-1.5 group-hover:-rotate-45 transition duration-300 ' />
                                    </Link>
                                </div>
                            </div>
